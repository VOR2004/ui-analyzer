...
class ComposeHardcodedTextRule : Rule {
    override val id: String = RuleIds.COMPOSE_HARDCODED_TEXT
        ...
        return ComponentUtils.flattenAll(components)
            ...
            .mapNotNull { component ->
                ...
                AnalysisIssue(
                    ...
                    message = AnalyzerMessages.composeHardcodedText(text),
                    recommendation = AnalyzerMessages.COMPOSE_HARDCODED_TEXT_RECOMMENDATION
                )
            }
    }
}
