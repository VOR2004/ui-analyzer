...
import ru.itis.xml.source.parser.DefaultAndroidManifestParser
import ru.itis.xml.source.parser.DefaultValuesResourceParser
import java.io.File
...
class DefaultResourceRepository(
    ...
    override fun resolveColor(value: String?): String? {
    ...
    override fun resolveDimension(value: String?): String? {
        if (value == null) return null
    ...
    override fun resolveStyleItem(styleName: String, itemName: String): String? {
    ...
    override fun resolveThemeAttribute(attributeReference: String?): String? {
    ...
    companion object {
        fun empty(): ResourceRepository {
            return ResourceRepository.empty()
        }

        fun load(projectRoot: File): DefaultResourceRepository {
            val parser = DefaultValuesResourceParser()
        ...
        fun fromValues(
            ...
            styles: Map<String, StyleResource> = emptyMap(),
            manifestInfo: AndroidManifestInfo = AndroidManifestInfo(applicationTheme = null)
